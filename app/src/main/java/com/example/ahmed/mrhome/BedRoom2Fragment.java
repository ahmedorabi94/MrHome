...
public class BedRoom2Fragment extends Fragment {
    ...
    String token;
    SeekBar seekBar_light_bedroom2;
    SeekBar seekBar_temp_bedroom2;
    TextView tv_light_bedroom2;
    TextView tv_temp_bedroom2;
    Switch switch_light;
    String light_value;
    Switch switch_temp;
    String temp_value;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bed_room2, container, false);

        setHasOptionsMenu(true);

        // instantiate the views
        tv_tempvalue = (TextView) view.findViewById(R.id.temp_value_bedroom2);
        seekBar_light_bedroom2= (SeekBar) view.findViewById(R.id.seekbar_light_bedroom2);
        seekBar_temp_bedroom2= (SeekBar) view.findViewById(R.id.seekbar_Temp_bedroom2);
        tv_light_bedroom2= (TextView) view.findViewById(R.id.tv_light_bedroom2);
        tv_temp_bedroom2= (TextView) view.findViewById(R.id.tv_Temp_bedroom2);
        switch_light= (Switch) view.findViewById(R.id.switch_light_bedroom2);
        switch_temp= (Switch) view.findViewById(R.id.switch_temp_bedroom2);
        switch_tv = (Switch) view.findViewById(R.id.switch_tv_bedroom2);
        ...
        // get the states and the values of the sensors of room 6 (Bedroom 2) from the database
        // and update them
        GetData(MainActivity.URL+"/mobile/get.php?token="+token,"6","room");
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                try {
                    ...
                    if(id.equals("24")){
                        ...
                        seekBar_light_bedroom2.setProgress(Integer.parseInt(val));
                    ...
                    if(id.equals("26")){
                        String state =  jsonObject.getString("state");
                        String val = jsonObject.getString("val");
                        seekBar_temp_bedroom2.setProgress(Integer.parseInt(val));
        ...
        seekBar_light_bedroom2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                tv_light_bedroom2.setText(String.valueOf(progress));
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if(switch_light.isChecked()){
                    ...
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"24","1", String.valueOf(progress));
                }else {
                    // when the switch of light is unchecked send the state 0 and value of progress to the server
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"24","0", String.valueOf(progress));
                }

            }
        });
        seekBar_temp_bedroom2.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                tv_temp_bedroom2.setText(String.valueOf(progress));
            }
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                if (switch_temp.isChecked()){
                    ...
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"26","1", String.valueOf(progress));
                }else {
                    // when the switch of temp is unchecked send the state 0 and value of progress to the server
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"26","0", String.valueOf(progress));
                }
            }
        });
        ...
        switch_temp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checked){
                    // when the switch  is checked send the state 1 and value of progress to the server
                    temp_value="1";
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"26",temp_value, String.valueOf(seekBar_temp_bedroom2.getProgress()));
                }else {
                    // when the switch  is unchecked send the state 0 and value of progress to the server
                    temp_value="0";
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"26",temp_value, String.valueOf(seekBar_temp_bedroom2.getProgress()));
        ...
        switch_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checked){
                    ...
                    tv_value="1";
                    SetData(MainActivity.URL+"/mobile/set.php?token="+token,"27",tv_value,"0");
                }else {
        ...
        // toggle for fire
        fire_toggle= (ToggleButton) view.findViewById(R.id.fire_toggle_bedroom2);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_bedroom2, menu);
    }
    ...
    private class GetTask extends AsyncTask<RequestPackage,Void,String>{
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                seekBar_light_bedroom2.setProgress(Integer.parseInt(light_maxval));
                ...
                seekBar_temp_bedroom2.setProgress(Integer.parseInt(temp_pref));
